...
const struct Tileset gTileset_CanvasTown =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CanvasTown,
    .palettes = gTilesetPalettes_CanvasTown,
    .metatiles = gMetatiles_CanvasTown,
...
const struct Tileset gTileset_CalcoridgeCity =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_CalcoridgeCity,
    .palettes = gTilesetPalettes_CalcoridgeCity,
    .metatiles = gMetatiles_CalcoridgeCity,
    .metatileAttributes = gMetatileAttributes_CalcoridgeCity,
    .callback = NULL,
};
