...
const u8 gText_ProfBirchMatchCallName[] = _("Prof. Cypress");
...
const u8 gText_DefaultNameKimmy[] = _("Clara");
const u8 gText_DefaultNameTiara[] = _("Clara");
const u8 gText_DefaultNameBella[] = _("Clara");
const u8 gText_DefaultNameJayla[] = _("Clara");
const u8 gText_DefaultNameAllie[] = _("Clara");
const u8 gText_DefaultNameLianna[] = _("Clara");
const u8 gText_DefaultNameSara[] = _("Clara");
const u8 gText_DefaultNameMonica[] = _("Clara");
const u8 gText_DefaultNameCamila[] = _("Clara");
const u8 gText_DefaultNameAubree[] = _("Clara");
const u8 gText_DefaultNameRuthie[] = _("Clara");
const u8 gText_DefaultNameHazel[] = _("Clara");
const u8 gText_DefaultNameNadine[] = _("Clara");
const u8 gText_DefaultNameTanja[] = _("Clara");
const u8 gText_DefaultNameYasmin[] = _("Clara");
const u8 gText_DefaultNameNicola[] = _("Clara");
const u8 gText_DefaultNameLillie[] = _("Clara");
const u8 gText_DefaultNameTerra[] = _("Clara");
const u8 gText_DefaultNameLucy[] = _("Clara");
const u8 gText_DefaultNameHalie[] = _("Clara");
const u8 gText_ThisIsAPokemon[] = _("This is what we call a {COLOR GREEN}Pokémon{COLOR DARK_GRAY}.{PAUSE 96}\p");
...
const u8 gText_DexSortLightestTitle[] = _("Tallest Mode");
...
const u8 gText_DexHoennDescription[] = _("Ryoko region's Pokédex");
...
const u8 gText_HOFDexRating[] = _("Spotted Pokémon: {STR_VAR_1}!\nOwned Pokémon: {STR_VAR_2}!\pPROF. CYPRESS's Pokédex rating!\pPROF. CYPRESS: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("Choose one!");
...
const u8 gMenuText_CheckTag[] = _("Inspect");
...
const u8 gText_BoxFull[] = _("Box is full.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Events[] = _("Eve"); // Unused
...
const u8 gText_Wallace[] = _("Lars");
const u8 gText_Steven[] = _("Lars");
...
const u8 gText_MenuOptionExit[] = _("{LEFT_ARROW} Exit");
...
const u8 gPCText_Release[] = _("{COLOR RED}Release");
...
const u8 gText_WithdrawPokemon[] = _("{COLOR BLUE}Withdraw Pokémon");
const u8 gText_DepositPokemon[] = _("{COLOR GREEN}Deposit Pokémon");
...
const u8 gText_CheckMapOfHoenn[] = _("Check the map of the Ryoko region.");
...
const u8 gText_SavingDontTurnOff_Chat[] = _("SAVING…\n{COLOR RED}DO NOT TURN OFF THE POWER.");
const u8 gText_PlayerSavedGame_Chat[] = _("{COLOR GREEN}{DYNAMIC 0} saved the game.");
...
const u8 gText_Sound[] = _("Sound Mix");
const u8 gText_Frame[] = _("Frame Style");
...
const u8 gText_TextSpeedMid[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Med");
...
const u8 gText_FrameType[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Style");
const u8 gText_FrameTypeNumber[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}");
const u8 gText_ButtonTypeNormal[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Default");
...
const u8 gText_MenuExit[] = _("{LEFT_ARROW}");
...
const u8 gText_MrStoneMatchCallDesc[] = _("Neighbor");
const u8 gText_MrStoneMatchCallName[] = _("Skip");
const u8 gText_StevenMatchCallDesc[] = _("Chilled Out");
const u8 gText_StevenMatchCallName[] = _("Lars");
