...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_LITTLEROOT_TOWN:
        return FlagGet(FLAG_VISITED_CANVAS_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_OLDALE_TOWN:
        return FlagGet(FLAG_VISITED_ROSSANO_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_CANVAS_TOWN;
